...
from cv2 import cv2 # For image reduction
import neat
import pickle
...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        while not done:
            ...
            ob = cv2.resize(np.array(ob),(inx,iny)) # Ob is the current frame
...
config = neat.Config(neat.DefaultGenome, neat.DefaultReproduction,
                     ...
                     r"C:\Users\Pavel\Documents\python\marioBrosML\config-feedforward")
